...
def desikan_killiany_tourville_labeling(t1,
    ...
    spatial_priors_file_name_path = os.path.join(antsxnet_cache_directory,'priorDktLabels.nii.gz')
    ...
    weights_file_name = os.path.join(antsxnet_cache_directory,'dktOuterWithSpatialPriors.h5')
    ...
    weights_file_name = os.path.join(antsxnet_cache_directory,'dktInner.h5')
    unet_model.load_weights(weights_file_name)
